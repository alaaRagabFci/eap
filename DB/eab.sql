...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2019 at 06:24 PM
...
(5, 'من نحن', 'Who We Are', 'لدينا خبرة أكثر من 20 عاما ومتخصصون في:\n⦁	الإستشارات.\n⦁	بناء القدرات.\n⦁	الإدارة.\n\nنقدم خدمات الاستشارات وتنمية القدرات والإدارة لمختلف أنواع المنظمات (المنظمات الحكومية والهيئات والمنظمات العامة شبه المستقلة، المنظمات الغير حكومية، والقطاع الخاص)، للمساعدة على تطوير وتحديث هذه المنظمات ونظم وأساليب وأدوات إدارتها، لجعلها قادرة على إستخدام المفاهيم والأساليب والتقنيات الحديثة وتطبقها فعليا.\n\nوإحدى اهتماماتنا الرئيسية هي إصلاح وإعادة هيكلة مؤسسات ونظم الإدارة العامة لتحقيق خصائص الحوكمة، والمساعدة في تحويل مؤسسات الأعمال العامة ومؤسسات قطاع الأعمال للعمل بمفاهيم وأساليب وتقنيات مماثلة لتلك التي يستخدمها قطاع الأعمال الخاص بما في ذلك تخطيط العمل والإستراتيجيات المالية وإستراتيجيات السوق والتوجه نحو العميل عند تقديم الخدمة أو المنتج.', 'We have more than 20 years of experience and specialized in:\n⦁	Consultations.\n⦁	Capacity Building.\n⦁	Management.\n\nWe provide consultancy, capacity building, and management services to various types of organizations (governmental organizations, semi-autonomous governmental entities, NGOs, and private sector), to assist in modernizing these organizations and modernizing their management, to make them able to, and actually, utilise modern concepts, methods, and techniques. \n \nOne of our main interests is the reform and restructuring of the public administration and management to realize the characteristics of good governance,  and assist in transforming public and public business enterprises to work along similar concepts, methods, and techniques of private business including business planning, markets and financial strategies, client oriented services and production.', '/images/uploads/1555697380011a49b5009503089a8c24277a891b5bimage.png'),
(6, 'هدفنا', 'Our Purpose', 'يمكن تلخيص الغرض الحالي لشركة إيــاب على النحو التالي:\nيتمثل الشاغل الرئيسي لشركة إيـاب في العمل كمقدم لأعلي مستوي من المعرفة مع مساعدة عملائنا في تطوير وتحديث منظماتهم وعملياتهم، وخاصة الكيانات العامة والخاصة. والقوة الأساسية لشركة إيـاب هي المساعدة في وتسهيل تبني المفاهيم الحديثة في إطار المحيط الاجتماعي الثقافي والمحيط الاقتصادي المحدد لعملائنا.', 'Our current purpose can be briefly summarized as:\nEAP’s major concern is to act as a state-of-the-art knowledge provider while assisting our clients in developing and modernising their processes and organisations, particularly for public and private entities. It is a core strength of EAP to assist and facilitate the adaptation of modern concepts in our clients specific socio-cultural and economic settings.', '/images/uploads/155575910120dceffea5453751c25479ac14a89e30image.png'),
(7, 'رؤيتنا', 'Our Vision', 'ترتكز رؤيتنا على اعتبار أن المنظمات ومواردها البشرية لا يمكنها أن تؤدي وتنفذ بنجاح إلا عندما تمارس عملية تعلم مستمرة (تنظيمية وفردية) لتعمل وتتطور في بيئة متغيرة باستمرار. ويعد التعلم المستمر شرطًا أساسيًا لقدرة المؤسسة على تطبيق المفاهيم والأدوات والتقنيات المبتكرة.\nونحن نهدف إلى إعداد وتسهيل هذه العمليات بشكل مشترك وفي شراكة وثيقة مع عملائنا.\n\nبالنسبة إلى شركة إيـاب، فإن الأمر يتعلق بضرورة أن يتبع تنظيمها ومواردها البشرية والخبراء المنتسبين لها عملية تعلم مستمر وموجه ذاتيا لضمان تقديم خدمات استشارية حديثة ومبتكرة وموجهة نحو العميل.', 'Our vision is based on the consideration that organisations and their people can only successful operate and perform when they practise an ongoing (organisational and individual) learning process to act and evolve in a constantly changing environment.\nConstant learning is a crucial requisite for an organisation’s capability to apply innovative concepts, tools and techniques.\nWe aim to set up and facilitate these processes jointly and in close partnership with our clients.\nFor EAP, it is a matter of fact that its organisation, all staff members and affiliated experts need to follow a self-directed ongoing learning process to ensure state-of-the-art, innovative and client-oriented consultancy services.', '/images/uploads/1555759185c2040866d0e87860e7b437e86bc1b128image.png'),
(8, 'مبادئ أعمالنا', 'Our Business Principles', 'مبادئ العمل هي معتقدات والتزامات شركة إيـاب، وهي تمثل ما تؤيده وتدعمه وتلتزم به الشركة والكيفية التي يتم بها تقديم جميع خدماتها، وتحدد ثقافتنا، وتوجه سلوك مواردها البشرية والخبراء المنتسبين لها وقرارات الشركة. وهذه المبادئ', 'The business principles present EAP’s beliefs and commitments. They present, what EAP stands for, how all services are provided, determines our culture, guiding employee’s and associated expert’s behaviour and company decisions.', '/images/uploads/1555759291fb54a00c53cb38c5c501a6438088cb80image.png'),
(9, 'فريق الإدارة لدينا', 'Our Management Team', 'حسام محسن (فريق الإدارة – الشئون الفنية): أكثر من 20 عامًا من الخبرة:\n⦁	إستشاري تطوير مؤسسي وتنظيمي وإدارة وتنمية موارد بشرية في العديد من مشروعات المساعدة الفنية التي تمولها مختلف الوكالات المانحة (the Netherlands TA, EU, KfW, World Bank, GTZ/GIZ, USAID, DANIDA, FINIDA) والوزارات المصرية لصالح مختلف المنظمات الحكومية وشبه الحكومية وغير الحكومية المصرية والعربية والقطاع الخاص.\n⦁	نائب المدير العام، مدير الموارد البشرية، ومنسق المشروعات في شركة إياب للاستشارات والتدريب، مصر.\n\nأوليفر سباتجينز (فريق الإدارة - الشئون الفنية): أكثر من 20 عامًا من الخبرة:\n⦁	خبير مؤسسي وفي تنمية الموارد البشرية والتنمية المستدامة في العديد من مشروعات المساعدة الفنية في أوروبا وأفريقيا.\n⦁	المدير التنفيذي ورئيس فريق مشروعين في منغوليا ومصر.\n⦁	رئيس قسم دراسات التسويق في Fontys Hogescholen Venlo  في هولندا.\n⦁	محاضر مستقل في RAM STREAM Management-Seminare in Siegen and in Lad Nordhausen  في ألمانيا.\n\n\n\nمحمد إسماعيل (فريق الإدارة – الشئون الإدارية والمالية): أكثر من 15 عامًا من الخبرة في شركة إياب للاستشارات والتدريب، مصر:\n⦁	منسق مشروعات: تخطيط أنشطة/ مهام المشروعات، التنسيق بين الخبراء والاستشاريين، متابعة تنفيذ الخطط التشغيلية للمشروعات والمهام.\n⦁	نائب مدير عام الشؤون الإدارية والمالية والموارد البشرية.', 'Hosam Mohsen (Management Team- Technical): More than 20 years of experience as:\n⦁Institutional and organisational development and HRM and development consultant in several TA projects financed by different donor agencies (the Netherlands TA, EU, KfW, World Bank, GTZ/GIZ, USAID, DANIDA, FINIDA) and Egyptian ministries for the benefit of various Egyptian and Arab governmental, semi-governmental and non-governmental organizations and private sector.\n⦁Deputy general manager, human resources manager, and projects’ coordinator for EAP for Consultancy and Training, Egypt.\n\nOliver Spätgens (Management Team- Technical): More than 20 years of experience as:\n⦁Institutional, human resources development, and sustainable development expert in several TA projects in Europe and Africa.\n⦁Executive director and team leader of two projects in Mongolia and Egypt.\n⦁Head of Department Marketing Studies, Fontys Hogescholen Venlo in the Netherlands.\n⦁Freelance lecturer in RAM STREAM Management-Seminare in Siegen and in Lad Nordhausen in Germany. \n\nMohamed Ismail (Management Team\nAdministrative & Financial): More than 15 years of experience for EAP for Consultancy and Training, Egypt as: \n⦁Projects’ Coordinator: Planning projects’/assignments’ activities, coordinating among consultants and experts, and monitoring the implementation of projects’/assignments’ plans of operations.\n⦁Administrative, financial and human resources deputy general manager.', '/images/uploads/15557595681e3fa8046a23dddb62c0aef102fa3dbcimage.png');
...
(1, '/images/uploads/1555197526422dfa5a7635e09d70a701590a11cb3bimage.png', '/images/uploads/1555197526cab28721571e124b3d813bb74a9cbf8aimage.png', '1 شارع 293 (أمام المدخل الرئيسي للهيئة المصرية العامة للبترول وشركة جابكو) – المعادي الجديدة – القاهرة – مصر.', '1 St. No. 293, New Maadi, Cairo, Egypt.', 'hossam@eap.com2', '+20 (0)155 558 5024  -  +20 (2)270 22 170', 'http://www.facebook.com', 'http://www.twitter.com', 'http://www.google.com', 11742);
...
(1, 'Hossam', 'hossam@eap.com', '$2y$10$WmeLbczKuYFnEtCnOgm.ie3phaI4kG.lxAvjrC9bG2LViWv8TUxfW', 'StbHExwIXVi4pDnB5hMpSCSGU87chiIyzgQZr6hoOZBKUi3EyWycWIQIrsYI', '2017-10-24 09:30:04', '2019-04-12 19:15:10'),
