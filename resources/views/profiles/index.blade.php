...
@section('header','Our profile')
@section('head_description','Our profile')
@section('breadcrumb','Our profile')
@section('styles')
    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption font-dark">
          ...
          <span class="caption-subject bold uppercase">Our profile Data</span>
        </div>
        <div class="tools"> </div>
      </div>
