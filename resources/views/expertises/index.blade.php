...
@section('header','expertises')
@section('head_description','expertises')
@section('breadcrumb','expertises')
@section('styles')
    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption font-dark">
          ...
          <span class="caption-subject bold uppercase">expertises Data</span>
        </div>
        <div class="tools"> </div>
      </div>
