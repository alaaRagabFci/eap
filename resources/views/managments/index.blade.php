...
@section('title','Managments')
@section('header','Managments')
@section('head_description','Managments')
@section('breadcrumb','Managments')
@section('styles')
    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption font-dark">
          ...
          <span class="caption-subject bold uppercase">Managments Data</span>
        </div>
        <div class="tools"> </div>
      </div>
