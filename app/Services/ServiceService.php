...
class ServiceService
{
    ...
    public function createService($parameters)
    {
        try {
            ...
            return array('status' => 'true', 'message' => 'Service created');
        }
        catch(ModelNotFoundException $ex){
            return array('status' => 'false', 'message' => 'Service already exist');
        }
    }
    ...
    public function updateService($serviceId, $parameters, $images, $icon)
    {
        try {
            ...
            return array('status' => 'true', 'message' => 'Service updated');
        }
        catch(ModelNotFoundException $ex){
            return array('status' => 'false', 'message' => 'Service not found');
        }
